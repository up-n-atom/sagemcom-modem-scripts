...
pip install dist/xmo_remote_client-0.0.9-py3-none-any.whl
deactivate
```
...
python3 -m venv .venv
source .venv/bin/activate
pip install https://github.com/up-n-atom/sagemcom-modem-scripts/releases/download/v0.0.6/xmo_remote_client-0.0.9-py3-none-any.whl
deactivate
```
